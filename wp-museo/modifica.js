$(document).ready(function(){
	...
	//Recuperiamo tutte le variabili
		...
		//Se i controlli vengono superati, compare un messaggio di invio in corso
		    ...
		    var datastr = 'id=' + id +'&nome=' + nome + '&localita=' + localita + '&indirizzo=' + indirizzo + '&cap=' + cap + '&orario_apertura=' + orario_apertura + '&orario_chiusura=' + orario_chiusura + '&descrizione=' + descrizione + '&email=' + email;
